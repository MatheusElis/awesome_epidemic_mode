...
\include{./docs/0-resumo}
\include{./docs/1-introduction} %% 1o capítulo, começo do texto
\include{./docs/2-theoretical_referential}
\include{./docs/3-metodology}
\include{./docs/4-preliminar_results}
\include{./docs/5-conclusions}
