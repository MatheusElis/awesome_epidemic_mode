...
\titulo{Titulo em produção}
\title{Título Legal em inglês} %% 
\author{Matheus Elis da Silva} %% coloque o nome do(s) autor(es)
\descriccao{Proposta de Defesa de Dissertação de Mestrado do Curso de Pós-Graduação em Computação Aplicada, orientada pelo Dr. Leonardo B. L. Santos.}
