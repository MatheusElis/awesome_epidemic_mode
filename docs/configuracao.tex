...
\author{Sabrina Guilherme Marques} %% coloque o nome do(s) autor(es)
\descriccao{Dissertaç\~{a}o de Mestrado do Curso de P\'{o}s-Graduaç\~{a}o em Computação Aplicada, orientada pelo Dr. Nome do Orientador(a), aprovada em dd de m\^{e}s por extenso de aaaa.}
